...
<html lang="en">
    ...
    <body>
        <div style="width: 100%;max-width: 500px;padding: 15px;margin: auto; background:rgba(255, 255, 255, 0.9); border-radius: 20px;">
            <div class="row">
                <div class="col-12">
                    <div class="row mt-2">
                        ...
                        <div class="col-12" style="margin: auto">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword" class="col-sm-3 col-form-label">Password Ok</label>
                                <div class="col-sm-9">
